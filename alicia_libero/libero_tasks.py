...
TASKS: list[dict] = [
    ...
    },
    {
        ...
        "name": "6) 把黑皮书推到盘子上（推/滑，不用夹）",
        "kind": "push",
        "difficulty": "★★",
        "task_text": "把黑色封面的书推到盘子上（或盘子中央的标记区）。",
        "hint": "书宽 110~134mm，50mm 夹爪从上方夹不住（实测）——把夹爪降到贴近桌面，用指尖侧面推着书滑动。",
        "objects": [
        ...
        "target_object": "plate",
        "success": {"xy": [0.22, 0.10], "xy_tol": 0.085, "z_ref": "table", "z_band": [0.0, 0.06]},
    },
    {
